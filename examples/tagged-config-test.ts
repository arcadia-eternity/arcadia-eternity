...
function testTaggedConfigSystem() {
  ...
  console.log('已注册的配置：')
  console.log('- freeze.probability:', configSystem.getConfig('freeze.probability'))
  console.log('- freeze.duration:', configSystem.getConfig('freeze.duration'))
  console.log('- ice.damage:', configSystem.getConfig('ice.damage'))
  console.log('- burn.probability:', configSystem.getConfig('burn.probability'))
  ...
  console.log('添加冰冻增强后：')
  console.log('- freeze.probability (受到probability+freeze双重增强):', configSystem.getConfig('freeze.probability'))
  console.log('- freeze.duration (只受到freeze增强):', configSystem.getConfig('freeze.duration'))
