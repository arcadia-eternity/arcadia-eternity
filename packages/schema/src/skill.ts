...
export const AttackTargetOpinionSchema = StringEnum(Object.values(AttackTargetOpinion))

export const ignoreStageStrategySchema = StringEnum(Object.values(IgnoreStageStrategy))
...
export const SkillSchema = Type.Object({
  ...
  category: Type.Union(
    Object.values(Category).map(v => Type.Literal(v)),
    {
  ...
  target: Type.Optional(
    Type.Union(
      Object.values(AttackTargetOpinion).map(v => Type.Literal(v)),
      {
        default: AttackTargetOpinion.opponent,
      },
    ),
  ),
  multihit: Type.Optional(Type.Union([Type.Number(), Type.Tuple([Type.Number(), Type.Number()])])),
