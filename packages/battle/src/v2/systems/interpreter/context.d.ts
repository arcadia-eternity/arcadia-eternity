...
import type { UseSkillContextData, DamageContextData, HealContextData, RageContextData, AddMarkContextData, RemoveMarkContextData, SwitchPetContextData, StackContextData, ConsumeStackContextData, TransformContextData, TurnContextData } from '../../schemas/context.schema.js';
/**
...
export type BattlePhaseContext = UseSkillContextData | DamageContextData | HealContextData | RageContextData | AddMarkContextData | RemoveMarkContextData | SwitchPetContextData | StackContextData | ConsumeStackContextData | TransformContextData | TurnContextData;
