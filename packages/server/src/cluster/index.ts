...
export { RoomManager } from '../domain/battle/services/roomManager'
...
export type { RoomMigrationOptions, RoomCreationOptions } from '../domain/battle/services/roomManager'
