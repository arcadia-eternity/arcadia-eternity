    ...
    <div v-if="results" class="test-results">
      ...
      <el-card>
        <el-descriptions :column="2" border>
          <el-descriptions-item label="旧版本总时间"> {{ results.oldTime.toFixed(2) }}ms </el-descriptions-item>
          <el-descriptions-item label="新版本总时间"> {{ results.newTime.toFixed(2) }}ms </el-descriptions-item>
          ...
          <el-descriptions-item label="旧版本平均"> {{ results.avgOldTime.toFixed(3) }}ms/次 </el-descriptions-item>
          <el-descriptions-item label="新版本平均"> {{ results.avgNewTime.toFixed(3) }}ms/次 </el-descriptions-item>
        </el-descriptions>
      </el-card>
