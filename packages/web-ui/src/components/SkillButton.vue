  ...
  >
    ...
    <div class="relative flex h-full pointer-events-none">
      ...
      <div class="flex flex-col w-2/3">
        ...
        <div class="text-orange-500 text-base font-semibold [text-shadow:_1px_1px_0_black] mt-1">威力 {{ power }}</div>
        <div class="text-yellow-300 text-base font-semibold [text-shadow:_1px_1px_0_black] mt-1">怒气 {{ rage }}</div>
