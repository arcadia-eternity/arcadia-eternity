...
import { createBattleReportRoutes } from '@arcadia-eternity/server/src/battleReportRoutes'
import type { BattleReportConfig } from '@arcadia-eternity/server/src/battleReportService'
