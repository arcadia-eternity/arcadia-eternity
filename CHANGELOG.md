...
## [3.3.0](https://github.com/arcadia-eternity/arcadia-eternity/compare/arcadia-eternity-v3.2.8...arcadia-eternity-v3.3.0) (2026-06-03)
...
* **battle:** implement context entity lifecycle with recursive lookup ([e0a12df](https://github.com/arcadia-eternity/arcadia-eternity/commit/e0a12df61cb52ef24a8169e5e3e0d69a5bfb2129))
* **battle:** implement context entity lifecycle, integrate into phase handlers ([8ef8bd2](https://github.com/arcadia-eternity/arcadia-eternity/commit/8ef8bd20ee49113c95f16fc0a15040792ebde8ee))
...
* **engine:** add currentContextEntityId field to World ([3651973](https://github.com/arcadia-eternity/arcadia-eternity/commit/3651973783d45acaca467be92ec1279f19c51c34))
* **engine:** add generics to AttributeSystem and PhaseManager for compile-time type narrowing ([8505e10](https://github.com/arcadia-eternity/arcadia-eternity/commit/8505e104f8be66c0b405e2778dc66679ded7f740))
...
* **ci:** migrate pnpm overrides to pnpm-workspace.yaml, pin pnpm@10 in Dockerfile ([86da3d3](https://github.com/arcadia-eternity/arcadia-eternity/commit/86da3d35e1cfdecabe435d941011d288b176f8fc))
...
* **effect-editor:** add anyOf evaluator support for baseMarkId fields ([0d49fea](https://github.com/arcadia-eternity/arcadia-eternity/commit/0d49fea357aa3b36d626211bc97b83b86414a966))
...
* enforce stringEnum validation and derive UI options from manifest ([3af61b4](https://github.com/arcadia-eternity/arcadia-eternity/commit/3af61b439c8e0a613a3273a1521567d6493bb579))
...
* **lint:** resolve all @typescript-eslint/no-base-to-string errors (35 occurrences) ([2fd9bc7](https://github.com/arcadia-eternity/arcadia-eternity/commit/2fd9bc7f12c666d5e530c5bcf604115eca0c618a))
* **phases:** fix initialize signature mismatch in all 14 handlers ([0013647](https://github.com/arcadia-eternity/arcadia-eternity/commit/0013647d56afb06002777cec0812adbef837548f))
...
* replace pseudo-enums and string literals with engine-backed const enums ([390ecd7](https://github.com/arcadia-eternity/arcadia-eternity/commit/390ecd7028d8b42c6b5fd719d688c05b2c5edc57))
* resolve no-base-to-string eslint errors in changed files ([36cab42](https://github.com/arcadia-eternity/arcadia-eternity/commit/36cab42fa3c8676b4958d0b7125a8c9d94682bfa))
...
* unify effect validation - eliminate duplicate selector typing logic ([7e5ff7e](https://github.com/arcadia-eternity/arcadia-eternity/commit/7e5ff7e37d6f78188f51af04d998f2995c99f50b))
...
* **engine:** make World/PhaseManager/EffectPipeline generic with interface constraints ([5fbf413](https://github.com/arcadia-eternity/arcadia-eternity/commit/5fbf413a5cd33fbd7ce42f9445fec1d3024cf3e4))
* narrow AttributeSystem typing per entity kind ([e4d325f](https://github.com/arcadia-eternity/arcadia-eternity/commit/e4d325ff485278b4fd718d03c60d7c5057ea8e4f))
* **phase:** enforce symbol-based phase identifiers ([d30b548](https://github.com/arcadia-eternity/arcadia-eternity/commit/d30b5489abfdc6ee1bc371d74d0cdfa687a0b4ab))
* **phases:** derive PhaseRegistry from handler exports, remove duplication ([ed7d51f](https://github.com/arcadia-eternity/arcadia-eternity/commit/ed7d51f5d39128bfbb91069fe9187523d0098614))
* **types:** replace Record&lt;string, unknown&gt; with WorldSystems/ContextData ([8ef8bd2](https://github.com/arcadia-eternity/arcadia-eternity/commit/8ef8bd20ee49113c95f16fc0a15040792ebde8ee))
